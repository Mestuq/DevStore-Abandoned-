...
<?php
    ...
    $safetypath='safety/public/'.$room.'.txt';
    $istnieje=true;
	...
	{
        if($istnieje==false)
           fwrite($file, "UWAGA, odtwarzasz kopię zapasową z dnia ".date_default_timezone_get()." chatu publicznego ". $room  ."Pamiętaj o zasadach prywatnośći, oraz RODO. Safety zostało utworzone w celu monitorowania nękania, hejtu i łamaniu prawa. Nie ma na celu nikogo szpiegować. \n Jesteś na początku chatu! \n");
